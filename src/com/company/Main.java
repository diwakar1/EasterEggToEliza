...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (!question.toLowerCase().equals("q")) {
            String gs = getAllResponse(question);
            ...
            if ((inptList.contains("I")) || (inptList.contains("my")) || (inptList.contains("me"))
                ...
                System.out.println(getQualifiers()+ " "+ gs);
            }
            else {
                System.out.println(getHedges());
            }
        ...
        public static String getAllResponse (String s){
            int count = 0;
            String message = "";
